...
create table likerelations(aid int, uid varchar(255), primary key(aid, uid), foreign key(aid) references answers(aid) on DELETE CASCADE);
create table dislikerelations(aid int, uid varchar(255), primary key(aid, uid), foreign key(aid) references answers(aid) on DELETE CASCADE);
