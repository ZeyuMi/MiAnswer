				...
				<div class="well row">
					...
					<div id="myTabContent" class="tab-content">
					    <div class="tab-pane active" id="questions">
							...
							<h3><a href="http://127.0.0.1/MiAnswer/index.php/topics/show?tid=<?echo $topics[$i]['Topic']['tid'];?>"><?echo $topics[$i]['Topic']['title']?></a></h3>
							<?}?>
						</div>
						<div class="tab-pane" id="answers">
							<?for($i = 0; $i < count($answers); $i++){?>
							<h3><a href="http://127.0.0.1/MiAnswer/index.php/topics/show?tid=<?echo $answers[$i]['Topic']['tid'] ?>"><?echo $answers[$i]['Topic']['title'];?></a></h3>
